<template>
    ...
    <div class="office__output-container">
        <p class="heading heading__p">Medical Record Summary</p>
        <div class="office__output-inner-container">
            <p class="heading heading__p">Nothing see here...</p>
        </div>
    </div>
    <div class="office__output-container">
        <p class="heading heading__p">Ongoing Medication</p>
        <div class="office__output-inner-container">
            <p class="heading heading__p">Nothing see here...</p>
        </div>
    </div>
    <div class="office__output-container">
        <p class="heading heading__p">Prescription Clash Alerts</p>
        <div class="office__output-inner-container">
            <p class="heading heading__p">Nothing see here...</p>
        </div>
    </div>
